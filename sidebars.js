        ...
        items: [
{
    ...
    { type: 'link', href: '/release-notes', label: 'Release notes', className: 'top-category-separator'},
    {
        type: 'category',
      ...
      items: [
{
    ...
    },
    {
      ...
      link: {
        ...
        description: 'Choose a KB category to explore:',
        slug: '/kb',
        keywords: ['kb']
      },
      items: [
  ...
  scanSidebar: [
    { type: 'doc', label: 'Docs home', id: 'Docs home', className: 'home-back-link' },
    {
        type: 'category',
        label: 'Get started',
        collapsible: true,
  ...
  devSidebar: [
    { type: 'ref', label: 'Docs home', id: 'Docs home', className: 'home-back-link' },
    { type: 'doc', id: 'for-developers/developer-overview', label: 'Overview' },
    { type: 'doc', id: 'for-developers/developer-signin', label: 'Sign in to Semgrep' },
    {
        type: 'category',
