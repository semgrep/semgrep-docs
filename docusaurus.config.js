    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { from: "/semgrep-ci/managing-policy", to: "/semgrep-multimodal/policies" },
          { from: "/managing-policy", to: "/semgrep-multimodal/policies" },
          { from: "/semgrep-app/managing-policy", to: "/semgrep-multimodal/policies" },
          ...
          // Deepsemgrep
          { from: "/deepsemgrep/"                         , to: "/semgrep-multimodal/semgrep-pro-engine-intro" }     ,
          { from: "/deepsemgrep/deepsemgrep-introduction" , to: "/semgrep-multimodal/semgrep-pro-engine-intro" }     ,
          { from: "/deepsemgrep/deepsemgrep-examples"     , to: "/semgrep-multimodal/semgrep-pro-engine-examples" }  ,
          { from: "/deepsemgrep/semgrep-pro-data-flow"    , to: "/semgrep-multimodal/semgrep-pro-engine-data-flow" } ,
          ...
          { from: "/semgrep-app/rule-board/"                         , to: "/semgrep-multimodal/policies" }      ,
          ...
          /* APR  23, 2024  */
          { from: "/playground/" , to: "/semgrep-multimodal/editor" },
