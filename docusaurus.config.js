    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { from: "/semgrep-cloud-platform/gitlab-pr-comments/" , to: "/semgrep-appsec-platform/gitlab-pr-comments" } ,
          { from: "/semgrep-cloud-platform/dashboard/" , to: "/semgrep-appsec-platform/dashboard" } ,
          { from: "/semgrep-cloud-platform/email/" , to: "/semgrep-appsec-platform/email" } ,
          ...
          { from: "/semgrep-cloud-platform/slack/" , to: "/semgrep-appsec-platform/slack" } ,
