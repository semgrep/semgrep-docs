* **Reachable**: A finding is reachable if there's a vulnerable code pattern or vulnerable package in use. The finding should be addressed as soon as possible.
