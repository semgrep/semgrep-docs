...
- Semgrep AppSec Platform by going to Semgrep Code's [Findings page](https://semgrep.dev/orgs/-/findings?tab=open). For more details, see [Path of tainted data in Semgrep
  Code](/semgrep-multimodal/semgrep-pro-engine-data-flow).
...
To get cross-file (interfile) findings in your organization, follow the steps in [<i class="fa-regular fa-file-lines"></i> Perform cross-file analysis](/semgrep-multimodal/semgrep-pro-engine-intro).
