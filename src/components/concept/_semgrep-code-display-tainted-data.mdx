...
](/semgrep-code/semgrep-pro-engine-intro). See [Semgrep Pro Engine overview](/semgrep-code/semgrep-pro-engine-intro#run-cross-file-analysis-with-semgrep-appsec-platform) for general information about Semgrep Pro Engine.
