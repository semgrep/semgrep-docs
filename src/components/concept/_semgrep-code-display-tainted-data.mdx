...
To get cross-file (interfile) findings in your organization, follow the steps in [Enabling Semgrep Pro Engine](/semgrep-code/semgrep-pro-engine-intro#enabling-semgrep-pro-engine-in-semgrep-appsec-platform). See [Semgrep Pro Engine overview](/semgrep-code/semgrep-pro-engine-intro#run-cross-file-analysis-with-semgrep-appsec-platform) for general information about Semgrep Pro Engine.
