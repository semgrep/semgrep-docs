...
See [Configuration options for blocking findings and errors](/semgrep-ci/configuring-blocking-and-errors-in-ci#configuration-options-for-blocking-findings-and-errors-in-CI) for information about the modifications to `semgrep ci` you can make to change Semgrep's default behavior.
