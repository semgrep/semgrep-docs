:::info Prerequisite
- Add rules that use taint mode to your [Rule board](https://semgrep.dev/orgs/-/board). See [Semgrep Registry](https://semgrep.dev/explore) for specific rules. 
:::
...
- Get interfile findings in your organization. Follow the steps in [Enabling Semgrep Pro Engine](/deepsemgrep/deepsemgrep-introduction/#enabling-semgrep-pro-engine-in-semgrep-cloud-platform) documentation.
:::