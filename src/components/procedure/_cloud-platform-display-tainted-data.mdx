...
- Get interfile findings in your organization. Follow the steps in [Enabling Semgrep Pro Engine](/semgrep-code/semgrep-pro-intro/#enabling-semgrep-pro-engine-in-semgrep-cloud-platform) documentation. See [Semgrep Pro Engine overview](/semgrep-code/semgrep-pro-intro/) for general information about Semgrep Pro Engine.
:::
