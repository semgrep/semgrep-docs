...
To view detailed path of tainted data with dataflow traces, follow these steps:
...
- Get interfile findings in your organization. Follow the steps in [Enabling Semgrep Pro Engine](/semgrep-code/semgrep-pro-engine-intro/#enabling-semgrep-pro-engine-in-semgrep-cloud-platform) documentation. See [Semgrep Pro Engine overview](/semgrep-code/semgrep-pro-engine-intro/) for general information about Semgrep Pro Engine.
:::
