...
1. In your Semgrep AppSec Platform account, click **Rules > Policies** to enter the **Policies** page. Under **Modes <i class="fa-solid fa-gear"></i>**, you can quickly see if you have existing rules in either Comment or Block mode.
1. Optional: To configure Semgrep Secrets rules, click the **Secrets** tab.
