...
1. Under **Modes <i class="fa-solid fa-gear"></i>**, you can quickly see if you have existing rules in either Comment or Block mode.
...
Validation state policies allow you to define how Semgrep handles:

- Invalid findings: the secret has either been revoked or was never functional
...
1. Choose the mode you want Semgrep to set for **Invalid findings**.
1. Choose the mode you want Semgrep to set for **Validation errors**.
