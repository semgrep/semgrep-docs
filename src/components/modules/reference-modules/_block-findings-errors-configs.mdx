...
The following code snippets in different tabs display the position of the default flag in configuration files of various CI providers (the code snippets are shortened):
