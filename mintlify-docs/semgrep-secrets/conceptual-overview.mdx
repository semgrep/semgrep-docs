...
* Search using regex
* <Tooltip tip="Semgrep Secrets' ability to understand how data is used in code, including dataflow analysis and constant propagation." cta="See full definition." href="/semgrep-secrets/glossary#semantic-analysis">Semantic analysis</Tooltip>
* Validation
* <Tooltip tip="Measures how random a string is to help determine whether it is likely a secret and reduce false positives." cta="See full definition." href="/semgrep-secrets/glossary#entropy-analysis">Entropy analysis</Tooltip>
...
<Tooltip tip="Semgrep Secrets' ability to understand how data is used in code, including dataflow analysis and constant propagation." cta="See full definition." href="/semgrep-secrets/glossary#semantic-analysis">Semantic analysis</Tooltip> refers to Semgrep Secrets' ability to understand how data is used within your code. This differentiates Semgrep Secrets from regex-based detectors that simply define a pattern to match a piece of code.
