...
<p className='text-base text-[#24434f] dark:text-white' style={{ textAlign: 'right' }}>
  <a href="https://semgrep.dev/docs/release-notes/rss.xml" style={{ color: '#624def', textDecoration: 'none', fontWeight: '500' }} onMouseOver={(e) => e.target.style.textDecoration = 'underline'} onMouseOut={(e) => e.target.style.textDecoration = 'none'}>Subscribe to RSS feed</a>
</p>
</div>
