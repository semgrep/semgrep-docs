...
<Step>
Click **(<span className="placeholder">Number</span>) Change modes**, then click **Disabled**.
</Step>
</Steps>
...
Before proceeding, ensure that you have:
 ...
 - Enabled the option in your Semgrep organization settings.<br/>
    &emsp;&emsp;i. Click **Settings**. This takes you to the **General > Global** settings tab.<br/>
	&emsp;&emsp;ii. Enable the toggle under **Triage via code review comments**.<br/>
...
<CardGroup>
  <Card title="GitLab" icon="gitlab" href="/semgrep-appsec-platform/gitlab-mr-comments#triage-through-mr-comments" horizontal />
  <Card title="Bitbucket Cloud" icon="bitbucket" href="/semgrep-appsec-platform/bitbucket-cloud-pr-comments#triage-through-pr-comments" horizontal />
  <Card title="Bitbucket Data Center" icon="server" href="/semgrep-appsec-platform/bitbucket-cloud-pr-comments#triage-through-pr-comments" horizontal />
  <Card title="Azure DevOps" icon="windows" href="/semgrep-appsec-platform/azure-pr-comments#triage-through-pr-comments" horizontal />
</CardGroup>
...
Refer to [<Icon icon="external-link" iconType="solid"/> Bulk triage API documentation](https://semgrep.dev/api/v1/#tag/TriageService) for complete details.
