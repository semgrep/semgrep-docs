...
See [Supported Languages](/supported-languages) for the complete set of languages and [package managers](/semgrep-supply-chain/sca-package-manager-support) supported by Semgrep.

<CardGroup cols={3}>
  <Card
    title="Go"
    img="/images/icon-triage.svg"
    href="/cheat-sheets/go-xss"
  >
  ...
  <Card
    title="Java"
    img="/images/icon-triage.svg"
    href="/cheat-sheets/java-jsp-xss"
  >
