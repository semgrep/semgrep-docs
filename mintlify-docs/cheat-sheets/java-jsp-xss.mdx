---
title: "Prevent XSS for Java and Java Server Pages (JSP)"
sidebarTitle: "XSS in Java + JSP"
---
...
[`java.lang.security.audit.xss.no-direct-response-writer.no-direct-response-writer`](https://semgrep.dev/r/java.lang.security.audit.xss.no-direct-response-writer.no-direct-response-writer)
...
[`java.lang.security.audit.xss.jsp.use-escapexml.use-escapexml`](https://semgrep.dev/r/java.lang.security.audit.xss.jsp.use-escapexml.use-escapexml)
