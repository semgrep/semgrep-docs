...
[`python.flask.security.audit.render-template-string.render-template-string`](https://semgrep.dev/r/python.flask.security.audit.render-template-string.render-template-string)
...
[`python.flask.security.unescaped-template-extension.unescaped-template-extension`](https://semgrep.dev/r/python.flask.security.unescaped-template-extension.unescaped-template-extension)
...
[`python.flask.security.xss.audit.explicit-unescape-with-markup.explicit-unescape-with-markup`](https://semgrep.dev/r/python.flask.security.xss.audit.explicit-unescape-with-markup.explicit-unescape-with-markup)
...
[`python.flask.security.audit.directly-returned-format-string.directly-returned-format-string`](https://semgrep.dev/r/python.flask.security.audit.directly-returned-format-string.directly-returned-format-string)
...
[`python.flask.security.xss.audit.direct-use-of-jinja2.direct-use-of-jinja2`](https://semgrep.dev/r/python.flask.security.xss.audit.direct-use-of-jinja2.direct-use-of-jinja2)
...
[`python.flask.security.xss.audit.template-autoescape-off.template-autoescape-off`](https://semgrep.dev/r/python.flask.security.xss.audit.template-autoescape-off.template-autoescape-off)
...
[`python.flask.security.xss.audit.template-href-var.template-href-var`](https://semgrep.dev/r/python.flask.security.xss.audit.template-href-var.template-href-var)
