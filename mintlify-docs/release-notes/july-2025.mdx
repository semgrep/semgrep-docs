...
<CardGroup>
  <Card title="Search, filter, and sort findings in Semgrep AppSec Platform" icon="search" href="/kb/semgrep-appsec-platform/search-filter-sort-findings" horizontal />
  <Card title="Automate private rules deployment using the Semgrep API" icon="gear" href="/kb/semgrep-appsec-platform/automate-rules-deployment" horizontal />
  <Card title="Why the count of findings differs across various pages in Semgrep AppSec Platform" icon="bar-chart" href="/kb/semgrep-appsec-platform/findings-count-differ-platform" horizontal />
</CardGroup>
...
<CardGroup>
  <Card title="1.131.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.131.0" horizontal />
  <Card title="1.130.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.130.0" horizontal />
  <Card title="1.128.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.128.0" horizontal />
</CardGroup>
