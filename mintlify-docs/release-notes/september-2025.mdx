...
<CardGroup>
  <Card title="1.135.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.135.0" horizontal />
  <Card title="1.136.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.136.0" horizontal />
  <Card title="1.137.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.137.0" horizontal />
  <Card title="1.138.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.138.0" horizontal />
</CardGroup>
