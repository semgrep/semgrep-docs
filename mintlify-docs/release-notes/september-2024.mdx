...
<CardGroup>
  <Card title="1.86.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.86.0" horizontal />
  <Card title="1.87.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.87.0" horizontal />
  <Card title="1.88.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.88.0" horizontal />
  <Card title="1.89.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.89.0" horizontal />
  <Card title="1.90.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.90.0" horizontal />
</CardGroup>
