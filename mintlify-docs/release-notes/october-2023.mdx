...
- Added a new, public [<Icon icon="external-link" iconType="solid"/> Semgrep Supply Chain API](https://semgrep.dev/api/v1/#tag/SupplyChainService) where you can filter and query third-party vulnerability findings by a variety of parameters, such as:
    - Severity
    - Repository
    - Exposure
