...
| <Tooltip tip="Software that interacts with a package registry to download, upload, or search for dependencies. Package managers typically generate manifest files or lockfiles. See full definition.">Package manager</Tooltip> | Issue | Solution |
| :--- | :--- | :--- |
