...
<tr rowspan="2">
   ...
   href="/semgrep-supply-chain/getting-started#scan-a-project-without-lockfiles-beta">Dynamic
   Dependency Resolution</a>.</td>
  </tr>
  <tr>
   <td>Maven</td>
   <td>Maven-generated dependency tree (see <a href="/semgrep-supply-chain/setup-maven/">Setting up SSC scans for Apache Maven</a> for instructions) <b>or</b> <br /><code>pom.xml</code> through <a
   href="/semgrep-supply-chain/getting-started#scan-a-project-without-lockfiles-beta">Dynamic
   Dependency Resolution</a>.</td>
  </tr>
  <tr>
...
<tr>
   <td>Maven</td>
   <td>Maven-generated dependency tree (See <a href="/semgrep-supply-chain/setup-maven/">Setting up SSC scans for Apache Maven</a> for instructions.)</td>
</tr>
  <tr>
