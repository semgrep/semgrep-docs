...
<CardGroup cols={2}>
<Card title="List all projects" horizontal icon="ballot" href="/api-reference/projectsservice/list-all-projects" />

<Card title="List code or supply chain findings" horizontal icon="code" href="/api-reference/findingsservice/list-code-or-supply-chain-findings" />
</CardGroup>
...
The [List Secrets](/api-reference/secretsservice/list-secrets) endpoint supports cursor-based pagination:
...
<CardGroup cols={2}>
  <Card title="List repositories with dependencies" href="/api-reference/supplychainservice/list-repositories-with-dependencies" icon="file" horizontal/>
  <Card title="List lockfiles in a given repository with dependencies" href="/api-reference/supplychainservice/list-lockfiles-in-a-given-repository-with-dependencies" icon="file" horizontal/>
  <Card title="List dependencies" href="/api-reference/supplychainservice/list-dependencies" icon="file" horizontal/>
</CardGroup>
