...
<CardGroup cols={2}>
<Card title="List all projects" horizontal icon="ballot" href="https://semgrep.dev/api/v1/#tag/ProjectsService/operation/ProjectsService_ListProjects" />

<Card title="List code or supply chain findings" horizontal icon="code" href="https://semgrep.dev/api/v1/#tag/FindingsService/operation/FindingsService_ListFindings" />
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="List repositories with dependencies" href="https://semgrep.dev/api/v1/#tag/SupplyChainService/operation/SupplyChainService_ListRepositoriesForDependencies" icon="file" horizontal/>
  <Card title="List lockfiles in a given repository with dependencies" href="https://semgrep.dev/api/v1/#tag/SupplyChainService/operation/SupplyChainService_ListLockfilesForDependencies" icon="file" horizontal/>
  <Card title="List dependencies" href="https://semgrep.dev/api/v1/#tag/SupplyChainService/operation/SupplyChainService_ListDependencies" icon="file" horizontal/>
</CardGroup>
