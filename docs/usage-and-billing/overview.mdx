...
<sup>***</sup>Agentic Workflows runs use a variable number of credits based on compute used and AI tokens consumed. Credit use depends on repository size and other details of the codebase being scanned, such as how the application is structured and how many API methods it defines. Agentic Workflows typically use more credits than AI-powered detection scans because they perform broader, multi-step analysis. Start with a small set of important projects before expanding Agentic Workflows coverage.
