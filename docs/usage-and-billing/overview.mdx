...
In Semgrep AppSec Platform, usage and billing information is under **Settings**:

- **[Settings > Usage](https://semgrep.dev/orgs/-/settings/usage)**: View contributor seats and AI credit consumption for your organization.
- **[Settings > Billing](https://semgrep.dev/orgs/-/settings/billing)**: Upgrade products, purchase additional seats or credits, and manage your plan.

To upgrade or purchase additional products, see [Upgrade your Semgrep subscription plan](/usage-and-billing/plan-changes-and-payments).
...
| [AI-powered detection scanning](/semgrep-code/ai-powered-detection-concepts)<sup>**</sup> | Variable per scan | Runs a full API-focused scan for issues such as IDOR and broken authorization |
...
- Purchasing additional licenses. See [Additional usage and reconciliation of licenses](/usage-and-billing/reconciliation) for additional information on how these purchases affect your account.
