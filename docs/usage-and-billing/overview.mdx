...
<sup>***</sup>Agentic workflow runs use a variable number of credits based on compute and AI tokens consumed. Credit use depends on repository size, number of repositories, and complexity. Agentic Workflows typically use more credits than AI-powered detection scans because they perform broader, multi-step analysis. Start with a small set of important projects before expanding Agentic Workflows coverage.
