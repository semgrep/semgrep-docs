...
Small teams may be eligible for Semgrep's discounted startup pricing. Fill out the <a href="https://semgrep.dev/contact/contact-us-startups" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> startup pricing</a> form to apply.
