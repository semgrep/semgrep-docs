...
<Steps>
  ...
  <Step>
    Go to **[Settings > Billing](https://semgrep.dev/orgs/-/settings/billing)**.
  </Step>
  <Step>
...
If you already have a paid product, you can still use **Settings > Billing** to purchase additional products.
