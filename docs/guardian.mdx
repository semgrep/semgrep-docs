...
description: "Set up Semgrep Guardian, an MCP server plugin for AI coding agents that scans AI-generated code and catches security issues before they ship."
---
