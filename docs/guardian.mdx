...
Semgrep does not support shared API tokens or service accounts for Guardian. Each developer should authenticate individually through OAuth (Claude Code) or `semgrep login` (local CLI integrations).
