...
<Steps>
<Step>
Install the Semgrep CLI using pipx, uv, or Homebrew. This requires Python 3.10 or later (the Semgrep CLI needs it at runtime regardless of how it was installed):
