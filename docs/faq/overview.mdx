...
Semgrep AppSec Platform provides centralized policy management. See the [Unified policies](/semgrep-appsec-platform/unified-policies/overview) for more details.
