...
- <a href="https://semgrep.dev/products/semgrep-code" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep Code</a>, a static application security testing (SAST) tool that can perform taint, cross-file, and cross-function analysis.
- <a href="https://semgrep.dev/products/semgrep-supply-chain/" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep Supply Chain</a>, which performs dependency scanning.
- <a href="https://semgrep.dev/products/semgrep-secrets/" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep Secrets</a>, which can detect and validate leaked secrets in code.
...
The Semgrep Registry can import rules from sources other than the `semgrep/semgrep-rules` repository, such as <a href="https://github.com/trailofbits/semgrep-rules" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Trail of Bits</a>. These rules have their own licenses.
...
- <a href="https://github.com/emacs-lsp/lsp-mode" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> LSP support for Emacs</a>
