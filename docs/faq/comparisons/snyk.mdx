...
Semgrep's policies management feature provides extensive flexibility, especially with respect to a developer's workflow. You can configure Semgrep to leave pull request or merge request comments, block pull requests or merge requests, create Jira tickets, send Slack notifications, and more whenever Semgrep identifies findings.
