...
To start a proof-of-value (POV), contact Sales at [<Icon icon="envelope" iconType="regular"/> sales@semgrep.com](mailto:sales@semgrep.com).
</Info>
...
- Number of hours **reduced** per developer, per year in triage time, research and fix time by having Semgrep Multimodal provide suggestions on how to fix findings and triage recommendations
...
<AccordionGroup>
<Accordion title="Click to view a sample of common questions you and your team may ask to identify specific needs and criteria to evaluate Semgrep.">
