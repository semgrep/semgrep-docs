...
- You can also set many of these environment variables within your local development environment. Set these variables in your command line then run `semgrep ci` while logged in to Semgrep CLI to test these environment variables locally.
