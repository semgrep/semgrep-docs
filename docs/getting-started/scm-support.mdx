...
description: "Reference table of source code managers and plans that Semgrep supports, including feature availability for GitHub, GitLab, Bitbucket, and Azure DevOps."
---
