...
<div className='flex flex-col gap-2 mb-6 mt-10 justify-center items-left'>
<h2 className='text-3xl font-bold text-[#24434f] dark:text-white'>What's New</h2>
<p className='text-xl text-[#24434f] dark:text-white'>See the latest Semgrep product highlights and weekly release notes.</p>
</div>

<CardGroup cols={2}>
  <Card title="What's New" icon="bullhorn" href="/whats-new" horizontal />
  <Card title="Subscribe to RSS" icon="rss" href="https://docs.semgrep.dev/whats-new/rss.xml" horizontal />
</CardGroup>
