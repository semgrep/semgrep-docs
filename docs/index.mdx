...
<p className='text-base text-[#24434f] dark:text-white mt-4'>
  <a href="/release-notes/2026-07-06" style={{ color: '#624def', textDecoration: 'none', fontWeight: '500' }} onMouseOver={(e) => e.target.style.textDecoration = 'underline'} onMouseOut={(e) => e.target.style.textDecoration = 'none'}>See the latest release notes →</a>
</p>
<p className='text-base text-[#24434f] dark:text-white' style={{ textAlign: 'right' }}>
  <a href="https://docs.semgrep.dev/whats-new/rss.xml" style={{ color: '#624def', textDecoration: 'none', fontWeight: '500' }} onMouseOver={(e) => e.target.style.textDecoration = 'underline'} onMouseOut={(e) => e.target.style.textDecoration = 'none'}>Subscribe to RSS feed</a>
</p>
</div>
