...
- **CLI**:
  ...
  - The CLI waits longer before retrying a request if it receives an HTTP `429` or `5xx` response from Semgrep.
  - Minor cosmetic changes to the **Scan Summary** section of the Semgrep CLI response.
  - Blocking findings are now labeled in the CLI response.
...
- Added information:
<CardGroup>
  <Card title="Managing and using Semgrep access tokens" icon="key" href="/deployment/tokens" horizontal />
  <Card title="Re-running Semgrep Managed Scans" icon="arrows-rotate" href="/kb/semgrep-appsec-platform/rerun-managed-scans" horizontal />
</CardGroup>
...
<CardGroup>
  <Card title="1.153.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.153.0" horizontal />
  <Card title="1.152.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.152.0" horizontal />
  <Card title="1.151.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.151.0" horizontal />
</CardGroup>