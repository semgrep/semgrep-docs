...
- **Advisories:** Added a tooltip displaying the date when a CVE Numbering Authority (CNA) created the security advisory. <a href="https://nvd.nist.gov/general/cve-process" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> CVE Numbering Authorities</a> include the MITRE Corporation. These dates are not assigned by Semgrep, Inc. {/* (10743) */}
    <Frame>
