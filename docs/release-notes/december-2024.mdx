...
- Semgrep can now scan your Java Gradle and Maven codebases without the need for a lockfile. This feature is in public beta for Java and private beta for Kotlin Gradle and Maven. See also [Scan a project without lockfiles](/semgrep-supply-chain/set-up-and-configure#scan-a-project-without-lockfiles-beta).
...
- Added the following new documents, articles and sections:
  ...
  - Instructions on [scanning a project without lockfiles](/semgrep-supply-chain/set-up-and-configure#scan-a-project-without-lockfiles-beta) in Semgrep Supply Chain. 
