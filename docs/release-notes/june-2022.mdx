...
- [Team or Enterprise Tier] You can now **tag** repositories within Semgrep App with up to 10 tags. Tagging enables teams to group together related repositories. Tags are implemented in [Semgrep's API](/api-reference/Introduction), enabling you to filter and group repository findings through tags.
