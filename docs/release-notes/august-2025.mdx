---
title: "August 2025"
description: "August 2025 release notes for Semgrep AppSec Platform, Semgrep Code, Supply Chain, Assistant, Secrets, and the Semgrep OSS Engine."
---
...
<CardGroup>
  <Card title="1.134.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.134.0" horizontal />
  <Card title="1.133.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.133.0" horizontal />
  <Card title="1.132.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.132.0" horizontal />
</CardGroup>
