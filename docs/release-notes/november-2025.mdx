...
- Fixed an issue where agreeing with an autotriage verdict incorrectly marked findings as ignored. Findings are now only auto-ignored when the user marks them as **False Positive**.
