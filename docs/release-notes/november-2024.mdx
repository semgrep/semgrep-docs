...
- **Dashboard**:
  ...
  - You can now export the Dashboard as a PDF. Sign in to <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform</a>, then click **Dashboard > Download > Download as PDF (report)**.
