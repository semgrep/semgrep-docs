...
- **Dashboard**:
  ...
  - You can now export the Dashboard as a PDF. Sign in to [<Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform](https://semgrep.dev/login), then click **Dashboard > Download > Download as PDF (report)**.
...
- Updated the following documents and sections:
  ...
  - [How Semgrep distinguishes new and duplicate findings](/semgrep-code/remove-duplicates)
...
- Clarified the relationship between ingress and egress IP addresses and Semgrep Network Broker.
...
<CardGroup>
  <Card title="1.97.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.97.0" horizontal />
  <Card title="1.96.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.96.0" horizontal />
</CardGroup>
