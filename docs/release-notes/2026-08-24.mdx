...
- [Developer exception requests](/semgrep-appsec-platform/developer-exception-requests) are now in public beta. Adminis can set developer triage permissions between no triage and full triage by adding **Require exception requests** to any policy.
...
- **Usage** and **Billing** are now separate tabs in Semgrep AppSec Platform **Settings**. 
