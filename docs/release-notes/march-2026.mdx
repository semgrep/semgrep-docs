...
- The [v1 API reference](/api-reference/Introduction) now documents request bodies for **POST**, **PUT**, and **PATCH** operations instead of showing those inputs as query parameters. **GET** and **DELETE** behavior in the reference is unchanged.
...
<CardGroup>
  <Card title="1.155.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.155.0" horizontal />
  <Card title="1.156.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.156.0" horizontal />
