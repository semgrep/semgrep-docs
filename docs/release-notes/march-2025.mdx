...
- Added the capability to delete projects through the Semgrep API. Deleting a project also deletes all of its findings. Refer to the [API documentation](/api-reference/v1/Introduction).
- You can now view the `cwe_names` and `owasp_names` for findings fetched through the Semgrep API. See the [API documentation](/api-reference/v1/Introduction).
...
- Added the ability to [download SBOM exports using the Semgrep API](/api-reference/v1/supplychainservice/create-a-new-sbom-export-job).
