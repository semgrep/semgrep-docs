...
- Updated Semgrep Assistant for Code docs to reflect its public beta status and new self-serve flow. Semgrep Assistant is available to any user of Semgrep Cloud Platform.
