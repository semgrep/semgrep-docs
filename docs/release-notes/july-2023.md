...
This section of release notes includes upgrades of Semgrep OSS Engine for versions ranging between **1.31.0** and **1.34.1**.
...
* PromQL (Prometheus Query Language): Initial language support. ([#8281](https://github.com/returntocorp/semgrep/pull/8281))
