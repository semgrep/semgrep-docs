...
- [<Icon icon="external-link" iconType="solid"/> Rules & Policies > Advisories](https://semgrep.dev/orgs/-/advisories)
- [<Icon icon="external-link" iconType="solid"/> Product updates feed](https://semgrep.dev/products/product-updates/)
</Info>
...
Semgrep no longer matches anything with the following rules:
...
- New secrets detection rules which try to resolve cases with hardcoded strings used as secrets in code:
