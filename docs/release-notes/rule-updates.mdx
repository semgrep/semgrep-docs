...
- <a href="https://semgrep.dev/orgs/-/advisories" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Rules & Policies > Advisories</a>
- <a href="https://semgrep.dev/products/product-updates/" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Product updates feed</a>
</Info>
