...
* You can now rename projects (repositories). This feature may be useful when you change the name of your repository in your source code manager. To rename a project from within Semgrep Cloud Platform, do the following:
    ...
    &emsp;&emsp;i. Click **[Projects](https://semgrep.dev/orgs/-/projects/)**.

    &emsp;&emsp;ii. Click the **<Icon icon="gear" iconType="solid"/> gear icon** on the entry of the project you want to rename.

    &emsp;&emsp;iii. Click the **<Icon icon="ellipsis-h" iconType="solid"/> three-dot icon > Rename project**.

    &emsp;&emsp;iv. Enter the name of the new project and click **Rename**.
    &emsp;&emsp;<Frame>
    &emsp;&emsp;![Screenshot of repository rename modal](/images/projects-rename-repo-81ad3fa1bd76d58958cb7cacef579a46.png)
    &emsp;&emsp;</Frame>
