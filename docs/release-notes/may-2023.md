...
- Added new [Policies](/semgrep-code/policies) page documentation, also updated [Rule board](/semgrep-code/policies) documentation with an admonition about Policies page.
...
- Admonitions regarding the new Turbo mode were added to Playground and Editor documentation. Go to [Playground](/editor) documentation and search for turbo mode.
