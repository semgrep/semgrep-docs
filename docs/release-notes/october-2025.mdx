...
- Semgrep Code findings now show Assistant's true or false positive analyses more prominently, along with which memories Assistant used during analysis. The findings also present the threat model for specific security issues in the context of the code, along with a summary of each issue.
...
<CardGroup>
  <Card title="1.142.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.142.0" horizontal />
  <Card title="1.141.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.141.0" horizontal />
  <Card title="1.140.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.140.0" horizontal />
</CardGroup>
