...
<CardGroup>
  <Card title="1.121.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.121.0" horizontal />
  <Card title="1.122.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.122.0" horizontal />
  <Card title="1.123.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.123.0" horizontal />
</CardGroup>
