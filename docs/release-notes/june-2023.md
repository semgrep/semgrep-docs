...
* You can now select a default RBAC (role-based access control) role. Refer to [Setting a default role](/semgrep-cloud-platform/user-management/#setting-a-default-role).
...
* Added a new document about [Semgrep Assistant](/semgrep-code/semgrep-assistant-code).
