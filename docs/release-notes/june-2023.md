...
* You can now select a default RBAC (role-based access control) role. Refer to [Setting a default role](/semgrep-appsec-platform/user-management/#setting-a-default-role).
