...
- Issues created by [Semgrep Agentic Workflows](/workflows/overview) are now available through the experimental [v2 API](/api-reference/v2/publicissuesservice/list-issues).
