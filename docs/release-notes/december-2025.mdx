...
### Changed
- The **Dependencies** page's **License** filter now supports the selection of multiple license types, so you can view dependencies that are **Allowed**, **Blocked**, and **Commented** at the same time. 
...
<CardGroup>
  <Card title="1.145.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.145.0" horizontal />
  <Card title="1.146.0" icon="code-branch" href="https://github.com/semgrep/semgrep/releases/tag/v1.146.0" horizontal />
</CardGroup>