...
- Jira integration is now in **private beta** for existing customers.
    ...
    - To enable this feature:
        ...
        &emsp;&emsp;a. Fill out the following form: [Request access to the Semgrep Jira integration private beta](https://get.semgrep.dev/Jira-private-beta.html).

        &emsp;&emsp;b. Contact your Technical Account Manager or your Account Executive and let them know you'd like to try out the Jira integration.
...
- Added icons for **Severity** and **Source** columns in the **Policies** page. The following icons can be seen in the **Source** columns:
    - <Icon icon="pen-nib" iconType="solid"/> Custom rules
    - <Icon icon="diagram-project" iconType="solid"/> Community rules
    - <Icon icon="crown" iconType="solid"/> Semgrep Pro rules

<Frame>
![Icons for Sources and Severities](/images/july2023-newicons-e749d5f857f31935f85e28d3babc7fae.png)
</Frame>
...
- Semgrep documentation has added ChatGPT-4 as an experimental means for users to learn about Semgrep. Click the **<Icon icon="comment" iconType="solid"/> floating chat icon** and enter a question to receive answers and sources for those answers. This service is powered by [Markprompt](https://markprompt.com).
