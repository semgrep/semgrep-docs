...
- Code's Autofix pull requests now post the email of the user who requested the pull request when that user doesn’t have a source code manager handle associated with their Semgrep login.
