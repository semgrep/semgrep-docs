...
- Added a Jira API endpoint to create Jira tickets, either by passing a list of `issue_ids` or filter query parameters to select findings. Refer to the [Jira API documentation](/api-reference/v1/ticketingservice/create-jira-tickets).
...
- Added an API endpoint you can use to triage findings in bulk, either by passing a list of `issue_ids` or filter query parameters to select findings. Refer to [Bulk triage API documentation](/api-reference/v1/triageservice/bulk-triage).
