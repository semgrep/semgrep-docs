...
- Added a list of default branch names that Semgrep uses to identify trunk or mainline branches.
...
- Documentation site look and feel: Minor cosmetic improvements.
