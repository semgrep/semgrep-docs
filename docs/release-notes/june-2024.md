...
- Added the ability to define separate ignore lists. Users can now define one for Semgrep Code and Supply Chain and another for Semgrep Secrets.
...
- Added a toggle to disable pull request or merge request comments for reachable Supply Chain findings.
