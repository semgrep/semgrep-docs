...
- Findings counts on the **Projects** page now include **Reviewing** and **To fix** findings, in addition to **Open**. A **Counts updated** tooltip on the Projects list explains the change.
