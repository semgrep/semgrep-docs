...
- Clicking on the Project Name in the Projects page now takes you to that project's Findings page. Click the <Icon icon="gear" iconType="solid"/> **gear** icon at the end of the Project's row to go to the project's Settings page.
