...
- Release notes that you are now reading have been split into one document for each month, and the Release notes category now has its own dedicated right sidebar. This change makes it easier to find changes that happened over the span of a month.
