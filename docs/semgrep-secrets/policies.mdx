...
To access the policies page for Semgrep Secrets, sign in to <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform</a> and navigate to **Rules & policies > Policies > Secrets**.
