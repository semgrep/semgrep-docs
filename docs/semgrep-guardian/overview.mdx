...
Guardian has two integration paths, and which one you use changes how you authenticate and whether you need a local Semgrep CLI:
...
Both paths scan with the same fixed ruleset. Rules enabled in your organization's Policies do not apply to Guardian scans — see [Rules and configuration](/semgrep-guardian/rules-and-configuration).
