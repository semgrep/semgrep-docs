...
Coverage is strongest for Python, Java, JavaScript, and TypeScript. If you have used an earlier version of Guardian, you may see more findings. The ruleset includes more rules than those versions.

If Guardian does not detect an issue that your agent introduces, report it in the `#mcp` [Slack community](https://go.semgrep.dev/slack) so Semgrep can evaluate it for the ruleset.
