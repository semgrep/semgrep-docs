...
5. Navigate to your repository's CI/CD settings, scroll down to `Variables`, and click 'expand'. The url will look like https://gitlab.com/myusername/myproject/-/settings/ci_cd.
