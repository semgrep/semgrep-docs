...
- An **Analyze** button provides you with the option to generate Multimodal Suggested fix guidance if analysis hasn't run yet.
...
**D - Multimodal Suggested fix**<br/>
Generate and view suggestions on how to fix findings from Semgrep Multimodal. You can also customize the suggestions using [Memories](/semgrep-multimodal/customize#add-memories).
