...
- **Alert boxes** now appear at the top of the page. If a finding is reachable, if Semgrep Multimodal thinks a finding is a false positive, or if a secret finding is validated, Semgrep immediately places this information at the top of the page.
- An **Analyze** button provides you with the option to generate Multimodal remediation guidance if analysis has not run yet.
...
**D - Multimodal remediation guidance and Suggested fix**<br/>
Generate and view remediation guidance and Suggested fix from Semgrep Multimodal. You can also customize remediation guidance using [Memories](/semgrep-multimodal/customize#add-memories).
