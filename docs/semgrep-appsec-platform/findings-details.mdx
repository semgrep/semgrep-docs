...
description: "Overview of the redesigned v2 findings details page in Semgrep AppSec Platform, including new metadata, remediation, and triage sections."
---
...
- An **Analyze** button provides you with the option to generate Multimodal remediation guidance if analysis hasn't run yet.
