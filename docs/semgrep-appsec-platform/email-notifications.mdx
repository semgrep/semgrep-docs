...
<note>
  <strong>Note:</strong> Email notifications are not supported by Unified Policies. If you currently have an email integration set up with your legacy policies, no additional emails will be sent after you migrate to Unified Policies.
</note>
