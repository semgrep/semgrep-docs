...
- Open
- Ignored, including provisionally ignored findings
- Fixed
...
| Total ignored  | Total number of **Ignored** findings during the time period that **remained** ignored until the end of the time period. Includes **provisionally ignored** findings. |
...
| Backlog activity | Displays the number of new, net new, fixed, and ignored findings. Ignored findings include provisionally ignored findings. A greater **Fixed** value is better. <br /><br />Clicking on this chart opens a drawer that provides a breakdown of findings by triage state for that selected time period. |
