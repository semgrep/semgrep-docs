...
You can [view dataflow traces in the PR comments created by Semgrep Code running in your CI/CD system](/semgrep-appsec-platform/github-pr-comments/#view-the-path-of-tainted-data-in-pr-comments).
