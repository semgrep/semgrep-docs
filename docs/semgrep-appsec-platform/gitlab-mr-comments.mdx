...
<Step>
Provide a custom comment for each Semgrep product whose findings you want to generate an MR comment. Semgrep supports HTML, Markdown, and plaintext links in your message.
</Step>
<Step>
Click **Save changes**.
</Step>
