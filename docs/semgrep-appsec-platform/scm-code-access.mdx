...
Use this page for **how** to grant Semgrep code read or write access on an existing SCM connection: update a private GitHub App, or create and paste an access token.
