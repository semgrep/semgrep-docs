...
Some Semgrep features require Semgrep to read repository contents, including [Semgrep Managed Scans](/deployment/managed-scanning/overview) and [Semgrep Multimodal](/semgrep-multimodal/overview).
