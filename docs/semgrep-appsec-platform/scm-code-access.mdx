...
Some Semgrep features, including [Semgrep Managed Scans](/deployment/managed-scanning/overview), [Semgrep Multimodal](/semgrep-multimodal/overview), [Autofix](/semgrep-code/triage-remediation/autofix), and [Semgrep Agentic Workflows](/workflows/workflows) (beta), require Semgrep to read repository contents.
