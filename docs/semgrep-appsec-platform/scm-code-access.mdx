...
Create a GitHub personal access token (PAT), then add it to Semgrep. Semgrep recommends a **fine-grained** PAT. **Classic** PATs remain supported when your organization requires them.
