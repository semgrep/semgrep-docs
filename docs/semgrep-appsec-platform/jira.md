...
- You can automate the creation of tickets for high severity, high confidence findings in your [default branch](/deployment/add-semgrep-to-ci#default-branch-names).
  ...
  - Tickets are automatically created for **new** findings identified by scans that occur after enabling automated ticket creation. Tickets are not automatically created for existing findings.
