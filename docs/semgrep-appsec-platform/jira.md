...
:::caution Limitations
Tickets can only be created for Supply Chain findings with **Always reachable** and **Reachable** usages. They cannot be created for **Conditionally reachable** or **Unreachable** findings.
:::
