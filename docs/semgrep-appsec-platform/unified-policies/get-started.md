...
4. When you have completed the migration process, you are redirected to the new **Policies** page, where you can manage your detection and remediation policies.
