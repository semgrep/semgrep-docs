...
<Step>
Find the policy named **Early notification for Supply Chain incidents**. Click its <Icon icon="ellipsis" iconType="solid"/> icon, then click **Edit policy**.
</Step>
<Step>
Select the **Logs** tab.
</Step>
...
Entries triggered by a Supply Chain incident show **From Supply Chain incident**. Demo and dry runs are not recorded.
