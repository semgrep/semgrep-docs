...
Notifications for Supply Chain incidents use a specific kind of remediation policy. This policy already exists for your organization and cannot be renamed or deleted. See [Supply Chain incident notifications](/semgrep-supply-chain/incident-notifications) for setup instructions.
</Info>
