...
Notifications for supply chain incidents use a special kind of remediation policy -- one that already exists for your organization, and cannot be renamed or deleted. See [Supply Chain incident notifications](/semgrep-supply-chain/incident-notifications) to set it up.
</Info>
