...
Some remediation policies are created for you by default and can't be renamed or deleted — only enabled and configured with actions. Supply Chain incidents, for example, use a dedicated policy that already exists for your organization.
