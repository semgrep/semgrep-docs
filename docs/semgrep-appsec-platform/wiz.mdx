...
![A list of Semgrep findings in Wiz](/images/semgrep-findings-in-wiz-87aefbc8c28ba9c86d5ba3f0361a6556.png)
</Frame>

<Frame caption="Detailed information for a finding sent by Semgrep to Wiz.">
![Detailed information for a finding sent by Semgrep to Wiz](/images/wiz-finding-details-2-ab0b87b440f3033e44e9c9cd2a5eb5d7.png)
</Frame>
...
- You must add the [Semgrep integration](https://app.wiz.io/settings/automation/integrations) from the Wiz Integration Network. During this process, save the following values shown to you:
   ...
   &emsp;&emsp;i. API Endpoint URL<br/>
   &emsp;&emsp;ii. Authentication URL
