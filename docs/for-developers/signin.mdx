...
Signing in to the <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform web app</a> enables you to:
...
<Steps>
<Step>
Sign in to <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform</a> with the account credentials specified by your admin.
</Step>
<Step>
