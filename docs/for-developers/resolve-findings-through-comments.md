...
![Semgrep Multimodal suggesting that a finding is safe to ignore.](/img/ai-assessment-tp-fp.png#md-width)
_**Figure**. Semgrep Multimodal suggesting that a finding is safe to ignore._
