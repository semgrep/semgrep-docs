...
- Step-by-step remediation instructions ([Guidance](/semgrep-multimodal/overview#guidance)).
- [Suggested fix](/semgrep-multimodal/overview#suggested-fix) suggestions on how to fix the finding. Suggested fix does not include inline code diffs.
