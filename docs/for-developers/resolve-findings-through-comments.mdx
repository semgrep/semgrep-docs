...
- [Suggested fix](/semgrep-multimodal/overview#suggested-fix) suggestions on how to fix findings. Suggested fix does not include inline code diffs.
- "Safe to ignore" suggestions.

<Frame caption="PR comment with Suggested fix suggestions on how to fix a finding.">
