...
| :--- | :--- | :--- |
|  Microsoft Visual Studio Code | <a href="https://marketplace.visualstudio.com/items?itemName=semgrep.semgrep" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> `semgrep-vscode`</a> | [Semgrep VS Code extension](/extensions/semgrep-vs-code) |
| IntelliJ Ultimate Idea<br />and many other IntelliJ products |<a href="https://plugins.jetbrains.com/plugin/22622-semgrep" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> `semgrep-intellij`</a> |[Semgrep IntelliJ extension](/extensions/semgrep-intellij) |
| Emacs | <a href="https://github.com/emacs-lsp/lsp-mode" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> `lsp-mode`</a> | See repository README |
...
Install the Semgrep extension:
   -  Visit <a href="https://plugins.jetbrains.com/plugin/22622-semgrep" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep's page on the JetBrains Marketplace</a>.
