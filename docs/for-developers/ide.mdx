...
| :--- | :--- | :--- |
|  Microsoft Visual Studio Code | [<Icon icon="external-link" iconType="solid"/> `semgrep-vscode`](https://marketplace.visualstudio.com/items?itemName=semgrep.semgrep) | [Semgrep VS Code extension](/extensions/semgrep-vs-code) |
| IntelliJ Ultimate Idea<br />and many other IntelliJ products |[<Icon icon="external-link" iconType="solid"/> `semgrep-intellij`](https://plugins.jetbrains.com/plugin/22622-semgrep) |[Semgrep IntelliJ extension](/extensions/semgrep-intellij) |
| Emacs | [<Icon icon="external-link" iconType="solid"/> `lsp-mode`](https://github.com/emacs-lsp/lsp-mode) | See repository README |
