...
<Step>
Click on **Projects and branches**, then click the **<Icon icon="chevron-down" iconType="solid"/> drop-down arrow** to view open branches, which is listed by its unique ID. For example, GitHub branches are represented by their PR number.
</Step>
<Step>
