...
- Semgrep focuses on speed and ease of use. Semgrep doesn’t require a buildable environment, it doesn’t yet provide some of the analysis features of CodeQL. Semgrep has [limited intraprocedural dataflow](/writing-rules/data-flow/data-flow-overview/) and the proprietary [DeepSemgrep](/deepsemgrep/) extension to Semgrep provides parity in terms of interprocedural dataflow analysis for a subset of supported languages.
