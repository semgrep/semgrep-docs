...
:::note
- This document is for **Semgrep Pro** users; Semgrep OSS Engine does not have any usage limit. Compare [Semgrep OSS and Semgrep Pro] tk link
:::
...
Any type of Semgrep scan, with any Semgrep product, counts towards the contributor total.
...
### Different number of licenses per product
