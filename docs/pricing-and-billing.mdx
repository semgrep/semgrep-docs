...
| Interfile (across multiple files or cross-file) analysis  |  ❌  | ✔️   |
...
| -------  | ----------  | ----------------- |
| [Centralized management of scan results (triage, remediation, fine-tuning noisy rules)](/semgrep-cloud-platform/rule-board) | ❌ | ✔️  |
...
| [Policy-based workflows†](/semgrep-code/rule-board/) |❌ | ✔️  |
