...
description: "Customize Semgrep CI jobs with diff-aware scans, scheduled full scans, timeouts, and monorepo splitting to fit your pipeline's performance needs."
---
