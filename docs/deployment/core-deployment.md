...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>SCA scanning</td>
            <td>Check that Semgrep either supports your manifest file and package manager or is capable of scanning your project without a manifest file or lockfile.</td>
        </tr>
        <tr>
