...
With **Teams** enabled, **Members** who are assigned to a team can view the projects for that team on the **Projects** page; whether they can start an on-demand scan from that page still depends on their scan permission and role.
