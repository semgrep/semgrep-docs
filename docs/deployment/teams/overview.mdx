...
You can quickly assign projects to large groups of users by first assigning users to teams and subteams within your organization. Once you've limited a user's access to a subset of your projects, their **Dashboard**, **Findings**, **Workflow jobs**, and **Workflow issues** pages all reflect that change. For example, their finding count is based on the total number of findings in the projects they can access.
...
| **Workflow jobs** | ⚠️&nbsp;Restricted. Scope is limited to jobs for projects assigned to the user's teams. | ⚠️&nbsp;Restricted. Scope is limited to jobs for projects assigned to the user's teams. | ⚠️&nbsp;Restricted. Scope is limited to jobs for projects assigned to the user's teams. | ✅&nbsp;Yes      |
| **Workflow issues** | ⚠️&nbsp;Restricted. Read-only users can perform no triage operations. | ⚠️&nbsp;Restricted. Members can perform all triage operations on issues for repositories assigned to them. | ⚠️&nbsp;Restricted. Managers can perform all triage operations on issues for repositories assigned to them. | ✅&nbsp;Yes      |
...
| Create tickets from Workflow issues | ❌&nbsp;No    | ⚠️&nbsp;Restricted | ⚠️&nbsp;Restricted | ✅&nbsp;Yes      | On deployments that use Teams, ticket creation follows the same scope as triage.                                                          |
...
<Frame>
  ![Team scopes diagram](/images/access-diagram-038e7132f085cf2adbc652f67ad56477.png)
</Frame>
