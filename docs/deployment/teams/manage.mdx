...
<Steps>
<Step>
In the <a href="https://semgrep.dev/orgs/-/settings/access/teams" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> **Teams** tab</a>, click **New team**. The **Create New Team** form appears.
</Step>
<Step>
...
<Steps>
<Step>
In the <a href="https://semgrep.dev/orgs/-/settings/access/teams" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> **Teams** tab</a>, click **<Icon icon="plus" iconType="solid"/> Add subteam** next to the name of the top-level team you want to create a subteam for. The **Create new subteam** form appears.
</Step>
<Step>
...
<Steps>
<Step>
In the <a href="https://semgrep.dev/orgs/-/settings/access/teams" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> **Teams** tab</a>, click the **<Icon icon="pen-to-square" iconType="solid"/> edit** icon on the row of the team or subteam you want to edit.
</Step>
<Step>
Make your changes.
</Step>
...
If you are deleting a team, delete its subteams first.
   ...
   i. In the <a href="https://semgrep.dev/orgs/-/settings/access/teams" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> **Teams** tab</a>, click the **<Icon icon="chevron-down" iconType="solid"/> down arrow** to show all subteams under a team, then follow steps 2-3.
</Step>
<Step>
