...
Confirm the following before you connect your SCM:

- Which SCM provider or providers Semgrep will use.
- Which features require SCM integration, such as PR or MR comments, Managed Scans, or AI-assisted triage.
- Whether someone in your organization can complete SCM setup for those features.

Roles, token scopes, and setup steps are listed in [SCM permissions](/deployment/prepare/scm-permissions).
