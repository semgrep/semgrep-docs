...
This page is a setup guide for SCIM provisioning. Only the Okta and Microsoft Entra ID workflows documented here are tested and supported during the beta.
...
While this feature is in beta, the following limitations:
