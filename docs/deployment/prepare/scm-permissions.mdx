...
| Agentic Workflows (beta) | User who can update the SCM connection token | Connection PAT scopes: <ul><li>`Code: Read`</li></ul> | <ul><li>[Semgrep Agentic Workflows](/workflows/workflows)</li><li>[Grant code access](/semgrep-appsec-platform/scm-code-access)</li></ul> |
...
| Agentic Workflows (beta) | User who can update the SCM connection token | Connection token scopes (colon notation): <ul><li>Cloud: `repository:read`</li><li>Data Center: `repository:read`</li></ul> | <ul><li>[Semgrep Agentic Workflows](/workflows/workflows)</li><li>[Grant code access](/semgrep-appsec-platform/scm-code-access)</li></ul> |
...
- [Semgrep Agentic Workflows](/workflows/workflows) (beta)
- [Semgrep Code Autofix](/semgrep-code/triage-remediation/autofix)

<Note>
Managed Scans, Multimodal, and Agentic Workflows [require **read access** to your code](/semgrep-appsec-platform/scm-code-access). Autofix also [requires **write access** and permission to open PRs](#autofix-permissions).
</Note>
