...
description: "Reference for the source code manager permissions and scopes required by each Semgrep feature across GitHub, GitLab, Bitbucket, and Azure DevOps."
---
