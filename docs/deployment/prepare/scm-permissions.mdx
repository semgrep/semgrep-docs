...
| Agentic Workflows (beta) | User who can update the SCM connection token | Connection PAT scopes: <ul><li>`Code: Read`</li></ul> | <ul><li>[Semgrep Agentic Workflows](/workflows/overview)</li><li>[Grant code access](/semgrep-appsec-platform/scm-code-access)</li></ul> |
...
| Agentic Workflows (beta) | User who can update the SCM connection token | Connection token scopes (colon notation): <ul><li>Cloud: `repository:read`</li><li>Data Center: `repository:read`</li></ul> | <ul><li>[Semgrep Agentic Workflows](/workflows/overview)</li><li>[Grant code access](/semgrep-appsec-platform/scm-code-access)</li></ul> |
...
- [Semgrep Agentic Workflows](/workflows/overview) (beta)
