...
<Steps>
<Step>
Create an HTTP access token with **Project admin** permissions. See [Bitbucket Data Center prerequisites](/deployment/managed-scanning/bitbucket#bitbucket-data-center).
</Step>
<Step>
...
In the **Connect your Bitbucket project (key)** dialog box, provide:
   ...
   - The **Access Token** that grants Semgrep permission to communicate with your project. See [Bitbucket Data Center prerequisites](/deployment/managed-scanning/bitbucket#bitbucket-data-center).
</Step>
<Step>
Click **Connect** to save and proceed.
</Step>
