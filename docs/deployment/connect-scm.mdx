...
description: "Connect Semgrep to GitHub, GitLab, Azure DevOps, or Bitbucket—cloud, on-premise, or single-tenant—to enable scanning, PR comments, and Managed Scans."
---
