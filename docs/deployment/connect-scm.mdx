...
You can connect to GitHub with Semgrep's GitHub App, or with a personal access token. Semgrep recommends the GitHub App. If you use a personal access token, see [GitHub personal access tokens](/deployment/prepare/scm-permissions#github-personal-access-tokens) for required roles and scopes.
