...
You can optionally create a private GitHub app, which follows the naming convention **Semgrep Multimodal - <span className="placeholder">YOUR_ORG_NAME</span>**. This private app is used for the following features:
