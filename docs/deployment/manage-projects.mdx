...
<Note>
Findings from a project marked as archived still show in the Semgrep AppSec Platform **Findings** pages. They are not included in the **Reporting** page or analytics.
</Note>
