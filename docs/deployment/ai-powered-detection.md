...
This page provides step-by-step instructions on enabling and running an AI-powered scan. For details on what AI-powered detection can uncover, known limitations, and beta considerations, see [AI-powered detection overview](/docs/semgrep-code/ai-powered-detection-concepts).
...
* You have enabled [Semgrep Multimodal](/docs/semgrep-multimodal/getting-started#enable-multimodal) for your organization.
...
1. Log in to Semgrep AppSec Platform.  
1. In the **navigation bar**, go to **Rules & Policies > Memories**.  
