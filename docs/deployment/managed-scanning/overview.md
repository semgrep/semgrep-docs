...
- Managed Scans is in **public beta** for all existing Semgrep AppSec Platform users with GitLab Cloud and GitLab self-managed plans. It requires a Premium or Ultimate subscription.
