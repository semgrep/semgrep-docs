...
Create the HTTP access token from your **user account** settings: **Profile picture > Manage account > HTTP access tokens**. Semgrep Managed Scans does not currently support HTTP access tokens created from **Project** or **Repository** settings.
