...
<Step>
If you have not completed the installation of public and private Semgrep GitHub apps, you are redirected to the **Set up Managed Scans** page, which facilitates the creation of both.<br/><br/>
...
<Steps>
<Step>
Ensure you have provided access to **both** the private and public Semgrep GitHub apps to the repositories you want to scan by following the steps in [Permissions and synchronicity](#permissions-and-synchronicity).
</Step>
<Step>
In Semgrep AppSec Platform, click <Icon icon="folder-open" iconType="solid"/> **Projects**.
</Step>
