...
| I want to receive AI assistance when I triage findings. | Enable [Semgrep Multimodal](/semgrep-assistant/overview). |
...
| I'd like to manage access to the resources that developers can view or change in Semgrep AppSec Platform.         | Configure [roles and users](/deployment/teams).  |
