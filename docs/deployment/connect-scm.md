...
1. Go to **<i class="fa-solid fa-gear"></i> Settings > Source code managers > Add > Azure DevOps**. <br />
...
1. The Bitbucket project is now listed under **Source Code managers**. Click **Test connection** to verify that the new integration is installed correctly.
...
2. Click **Connect** to save and proceed.
3. The Bitbucket project is now listed under **Source code managers**. Click **Test connection** to verify that the new integration was installed correctly.
...
1. Create a PAT by following the steps outlined in this [guide to creating a PAT](https://docs.gitlab.com/ee/user/profile/personal_access_tokens.html). Ensure that the PAT is created with the required `api` scope.
2. Sign in to [<i class="fas fa-external-link fa-xs"></i> Semgrep AppSec Platform](https://semgrep.dev/login).
...
1. The GitLab groups are now listed under **Source Code managers**. Click **Test connection** to verify that the new integration is installed correctly.
