...
You can also check or uncheck the boxes to post pull request comments or to block the build on findings. Don't forget to click Save when you are finished editing!
