...
sidebarTitle: "Python"
description: "Reference for Semgrep's Python support in Semgrep Code, including framework-aware analysis for Django, Flask, and FastAPI and 100+ library rules."
---
