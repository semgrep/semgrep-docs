...
title: "Java support"
sidebarTitle: "Java"
description: "Reference for Semgrep's Java support, including interfile analysis in Semgrep Code and Supply Chain scanning for Maven and Gradle projects."
---
...
Java projects can be scanned **without** the need for lockfiles. See [Dynamic Dependency Resolution (beta)](/semgrep-supply-chain/set-up-and-configure#dynamic-dependency-resolution-beta).
</Tip>
