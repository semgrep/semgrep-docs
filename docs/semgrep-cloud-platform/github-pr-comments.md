...
- To see meaningful results of dataflow traces in PR comments, use Semgrep Pro Engine while scanning your repositories to see cross-file results (results that show the path of data across multiple files). For more information, see [Semgrep Pro Engine overview](/semgrep-code/semgrep-pro-engine-intro/).
