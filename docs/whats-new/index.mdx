...
Curated feature highlights from recent Semgrep releases. For the complete Added, Changed, and Fixed lists, see the [full release notes](/release-notes/2026-07-20).

<Update label="Week of July 20, 2026" tags={["What's New"]}>
...
- **Developer exception requests**: Renamed from **developer approvals**. You can require them through a remediation policy automation action, see which policies enforce them in settings, and filter by multiple issue types when bulk-creating them.
