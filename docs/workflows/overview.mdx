...
| --- | --- | --- | --- |
| [Semgrep Code](/semgrep-code/overview) | Known insecure patterns defined in Semgrep rules. Runs continuously in CI or Managed Scans. | Applies deterministic rules to source code. | Code findings |
