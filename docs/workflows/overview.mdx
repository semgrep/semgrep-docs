...
| --- | --- | --- | --- |
| [Semgrep Code](/semgrep-code/overview) rule-based scanning | Known insecure patterns defined in Semgrep rules. Runs continuously in CI or Managed Scans. | Applies deterministic rules to source code. | Code findings |
...
| [Semgrep Agentic Workflows](/workflows/get-started) | On-demand detection across 70+ [CWEs](https://cwe.mitre.org/), including injection, XSS, SSRF, cryptography, and broader web, API, and crypto analysis. This coverage is additional to Semgrep Code and AI-powered detection. | Runs a built-in sequence of analysis steps, such as specialized analyzers and AI reasoning, against a selected repository. | Agentic Workflows issues |
