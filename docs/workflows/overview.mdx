...
<Frame caption="Architectural overview of Semgrep Workflows.">
<img src="/images/workflow-architecture-4db0965849a21a7df14b80883b0fa4ab.png" alt="Architectural overview of Semgrep Workflows" />
</Frame>
...
To get started with your first automated workflows, [<Icon icon="envelope" color="#04A876"/> contact Semgrep](mailto:sales@semgrep.com).
