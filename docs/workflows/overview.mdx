...
| --- | --- | --- | --- |
| [Semgrep Code](/semgrep-code/overview) rule-based scanning | Identify code that matches known insecure patterns | Applies deterministic rules to source code | Code findings |
