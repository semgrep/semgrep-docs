...
| [Semgrep Agentic Workflows](/workflows/get-started) | Combine multiple analysis techniques and execute them stepwise across repositories | Runs a built-in sequence of analysis steps, such as specialized analyzers and AI reasoning, against selected repositories | Agentic Workflows issues |
