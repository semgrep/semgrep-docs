...
- **Issue**: The deduplicated, processed output of the pipeline. Issues appear on the **Workflows** page in Semgrep AppSec Platform and in the **Workflow issues** column on the **Projects** page. They include the evidence and context available from the run.

When you start Agentic Workflows, Semgrep clones the repository through its source code manager connection. The workflow runs its jobs and produces findings. Semgrep processes and deduplicates those findings into reviewable issues. You can monitor jobs on the **Projects** page, open a project's issues from the **Workflow issues** column on **Projects**, or review issues across your organization on the **Workflows** page in Semgrep AppSec Platform.
