...
- Thanks @mtausig! <LinkToRegistryRule ruleId="csharp.dotnet.security.use_weak_rsa_encryption_padding" />
- <LinkToRegistryRule ruleId="yaml.github-actions.security.workflow-run-target-code-checkout" />
- Thanks @Sjord! <LinkToRegistryRule ruleId="php.lang.security.redirect-to-request-uri" />
...
New rules for Go covering the following vulnerability classes:
- SQL injection
- Command injection
