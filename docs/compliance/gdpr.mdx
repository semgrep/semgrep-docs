...
- **Article 25 (data protection by design and by default):** [Policy enforcement](/semgrep-appsec-platform/unified-policies/overview) demonstrates that security is built into your development process from the start. When properly configured with CI/CD systems, Semgrep can enforce secure coding practices at the pull request level. For details about proper configuration, please chat with the [Semgrep team](/support/).
