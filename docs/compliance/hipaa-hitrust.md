...
- **HIPAA Technical Safeguard 164.312(c)(1) and HITRUST control 01.o (integrity):** SAST rules detect code patterns that could allow data tampering, unauthorized modification of PHI records, or integrity violations. [Custom rules](/semgrep-multimodal/editor) can enforce data validation requirements and detect missing integrity checks in code that modifies PHI.
