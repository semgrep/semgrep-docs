...
Autofix is enabled for all customers. There is no settings toggle. You choose when to use Autofix by selecting **Open Autofix PR** on the finding’s **Details** page or by calling the API.
