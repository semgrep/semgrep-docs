...
* Confirm that your source code manager (SCM) and plan support Autofix. See [Supported source code managers](/getting-started/scm-support).
...
On GitHub, set **Repository permissions > Contents** to **Read and write** on the private app. See [Grant code access](/semgrep-appsec-platform/scm-code-access) for setup steps and how **Contents** differs from other GitHub App permissions.
