...
description: "Semgrep's Autofix beta uses AI to generate proposed code changes for Semgrep Code findings and open a draft pull or merge request with the fix."
---
