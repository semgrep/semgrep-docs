...
title: View findings
description: "The Code page allows users to view findings identified by Semgrep Multimodal."
hide_title: true
...
Semgrep Multimodal generates a **finding** when a rule matches a piece of code in your codebase. You can use Semgrep AppSec Platform's [**Code** page](https://semgrep.dev/orgs/-/findings) to view all of the findings generated by Semgrep Multimodal after it scans your codebase.
...
You can switch to the **All** tab at any point to view all findings identified by Semgrep Multimodal. Both the **Priority** findings view and the **All** findings view display high-level information about your findings.
...
| **Multimodal lifecycle** | Filter for findings based on whether they are **Production** findings or **Pre-production** findings. **Production** findings are those identified on primary branches, while **Pre-production** findings are those identified on pull request or merge requests. |
...
<FindingsDefaultView product_name="Multimodal" />

## Next steps

- Learn more about [viewing a finding's details](/semgrep-code/finding-details).
- Learn how to [triage and remediate Semgrep Multimodal findings](/semgrep-code/triage-remediation).
- Learn how to [get cross-file (interfile) findings for your organization](/semgrep-code/semgrep-pro-engine-intro)
- See [Semgrep Assistant for Semgrep Multimodal](/semgrep-assistant/overview) for information on receiving AI-powered security recommendations when reviewing your findings.
