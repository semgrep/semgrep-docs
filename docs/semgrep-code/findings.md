...
Semgrep Code generates a **finding** when a rule matches a piece of code in your codebase. You can use Semgrep AppSec Platform's [**Findings** page](https://semgrep.dev/orgs/-/findings) page to view all of the findings generated by Semgrep Code after it scans your codebase.
