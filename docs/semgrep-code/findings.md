...
| **Pro findings**       | Filter for findings identified using Semgrep Pro rules. Also includes findings originating from Pro Engine analysis; if Semgrep identifies a finding as the result of interfile analysis, it's included by this filter. |
