...
<Step>
Under **<Tooltip tip="In taint analysis, code that introduces tainted data, typically user input." cta="See full definition." href="/writing-rules/glossary#source">Source</Tooltip>**, click **Pro <Icon icon="gem" iconType="solid"/>** to view all the Semgrep Pro rules currently in your Policies.
</Step>
<Step>
...
You can find all previously added Semgrep Pro rules in your Policies page, so if you want to re-enable Pro rules or adjust the mode again in the future, use the **<Tooltip tip="In taint analysis, code that introduces tainted data, typically user input." cta="See full definition." href="/writing-rules/glossary#source">Source</Tooltip> > Pro <Icon icon="gem" iconType="solid"/>** filter as described previously.
