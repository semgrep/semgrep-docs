...
Interfile analysis rules you use in Semgrep Pro Engine require `interfile: true` key included in the metadata. See the following [example](https://semgrep.dev/s/3NZb).
