...
description: "Manage and triage Semgrep Code findings in Semgrep AppSec Platform, including reviewing, ignoring, prioritizing, and remediating vulnerabilities."
---
