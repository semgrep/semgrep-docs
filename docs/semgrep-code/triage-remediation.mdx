...
description: "Manage and triage Semgrep Code findings in Semgrep AppSec Platform by fixing issues, ignoring false positives, or removing rules that generated them."
---
