...
Semgrep Code also supports **[cross-file analysis](/semgrep-code/semgrep-pro-engine-intro/)** (interfile). These scans produce fewer false positives and more true positives, but take longer to complete.
...
- Use [Autofix](/semgrep-code/triage-remediation/autofix) to create AI-generated pull requests or merge requests with fixes.
