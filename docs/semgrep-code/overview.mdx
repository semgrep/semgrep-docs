...
- Provide [remediation guidance](/semgrep-multimodal/overview#remediation) and Suggested fix for Semgrep Code findings in Semgrep AppSec Platform and pull request or merge request comments.
  ...
  - [Autofix](/semgrep-code/triage-remediation/autofix) findings by opening PRs or MRs with AI-suggested fixes.
