...
- Provide [remediation advice](/semgrep-multimodal/overview#remediation) and Suggested fix for Semgrep Code findings in Semgrep AppSec Platform and pull request or merge request comments.
  - [Guidance](/semgrep-multimodal/overview#guidance) with step-by-step remediation instructions.
  - [Suggested fix](/semgrep-multimodal/overview#suggested-fix) with suggestions on how to fix findings. Suggested fix does not include inline code diffs.
