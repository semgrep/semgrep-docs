...
description: "Overview of Semgrep Code, a fast SAST tool covering rules, AI-powered detection, findings management, language support, and how it differs from CE."
---
