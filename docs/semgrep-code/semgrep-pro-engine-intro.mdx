...
<Steps>
<Step>
Sign up or sign in to <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Semgrep AppSec Platform</a>.
</Step>
<Step>
