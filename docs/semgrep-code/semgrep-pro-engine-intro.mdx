...
<Step>
Ensure that you have a [remediation policy](/semgrep-appsec-platform/unified-policies/get-started#manage-remediation-policies) to determine the actions Semgrep performs whenever a rule generates a finding. 
</Step>
</Steps>
