...
For cross-file and cross-function analysis (interfile and interprocedural analysis, respectively), you can enable [Semgrep Pro Engine](/semgrep-code/semgrep-pro-engine-intro). These scans produce fewer false positives and more true positives, but take longer to complete.
