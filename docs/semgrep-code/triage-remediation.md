...
* If a rule authored by the Semgrep team, available on the Registry, is useful, but captures too many false positives, you can reach out to [support@semgrep.com](mailto:support@semgrep.com). This helps Semgrep's rule-writing efforts and improves the quality of rules that you run.
