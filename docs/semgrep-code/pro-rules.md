...
:::info 
See the [Rule updates](https://semgrep.dev/docs/release-notes/rule-updates/) for an overview of updates and improvements released by r2c for Semgrep’s rules, including Semgrep Pro rules.
:::
