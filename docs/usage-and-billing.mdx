...
:::note
- This document is for **Semgrep AppSec Platform** users; Semgrep OSS Engine does not have any usage limit. Compare [<i class="fa-regular fa-file-lines"></i> Semgrep AppSec Platform and Semgrep OSS](/semgrep-pro-vs-oss).
:::

## Usage

All Semgrep Pro products are free under the **Team** tier for **5 monthly contributors**. These products include:
...
:::info
If your company creates multiple Semgrep organizations, the five-contributor limit applies across **all** of your organizations. You must purchase licenses for any additional contributors.
...
Your company has 27 contributors across three organizations. You must purchase 22 licenses to use with the 5 free licenses you’ve received.
:::
...
:::info
The number and price of additional licenses you need to buy depends on your team size. Semgrep provides a special pricing structure for startups.
:::
