...
<dl>
  ...
  <dd>The payment will be processed through Stripe. If you need to change the credit card on file, please reach out to{" "}
    <a href="mailto:billing@semgrep.com">billing@semgrep.com</a>, and Semgrep will contact you for your updated credit card information.</dd>
