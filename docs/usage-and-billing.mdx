...
:::info
Semgrep provides a special pricing program for small teams startups. Fill out the [<i class="fas fa-external-link fa-xs"></i> Startup pricing](https://semgrep.dev/contact/contact-us-startups) form to apply.
:::
