...
* **Custom rules** are rules that have been saved through either the [Playground](https://semgrep.dev/playground) or the Editor. The Playground is an online tool where you can write your rule patterns and test them on sample code.
...
* **Custom language support** refers to TODO
* **Autofix through PR/MR comments** TODO
