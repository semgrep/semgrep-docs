...
:::info
This page contains information for Semgrep App and Semgrep static application security testing (SAST) products. For Semgrep Supply Chain, a software composition analysis (SCA) product, see the [Semgrep Pricing](https://semgrep.dev/pricing) page.
:::
