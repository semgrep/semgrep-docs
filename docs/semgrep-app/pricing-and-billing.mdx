...
* **Named rules** are rules that have been saved through the [Playground](https://semgrep.dev/playground). The Playground is a live editor where you can write your rule patterns and test them on sample code. Named rules created by Community tier members are public and available in the Playground.
