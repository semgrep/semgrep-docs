...
To **view and add comment** to history of a finding:
...
Triage your Semgrep App findings that are displayed as comments in GitHub PRs by replying with another comment.
