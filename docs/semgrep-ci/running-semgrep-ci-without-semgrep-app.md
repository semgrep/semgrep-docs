...
3. Optional: If you have previously set a custom `SEMGREP_TIMEOUT` environment variable, it to the CI configuration file created by Semgrep App. Do not copy `SEMGREP_RULES`.
