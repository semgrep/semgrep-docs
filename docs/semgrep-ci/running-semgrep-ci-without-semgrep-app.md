...
* Stand-alone CI jobs cannot send [PR or MR comments](/semgrep-code/notifications/#enabling-github-pull-request-comments). These comments describe the finding and help developers resolve vulnerabilities and other code issues.
