...
description: "Set up the Semgrep Network Broker to create a WireGuard VPN tunnel that lets Semgrep securely reach private SCMs without exposing them to the internet."
---
