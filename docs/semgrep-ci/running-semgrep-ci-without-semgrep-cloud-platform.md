...
* Stand-alone CI jobs cannot send [PR or MR comments](/semgrep-cloud-platform/github-pr-comments). These comments describe the finding and help developers resolve vulnerabilities and other code issues.
