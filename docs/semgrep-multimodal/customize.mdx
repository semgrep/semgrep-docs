...
Multimodal **Suggested fix** includes an explanation on how to fix true positives. Unlike [Autofix](/semgrep-code/triage-remediation/autofix), Suggested fix does not include inline code diffs.
