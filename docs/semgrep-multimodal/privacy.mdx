...
**Retention:** Data is stored persistently for the lifetime of the finding and account.
...
**Retention:** Memories are stored persistently for the lifetime of the account.
...
Retention periods vary by feature:

- **Triage and remediation:** Stored for the lifetime of the finding and account.
- **Memories:** Stored for the lifetime of the account.
- **AI-powered detection scans:** Stored for up to 6 months, unless otherwise noted.

Semgrep will provide at least 30 days’ notice before making changes to retention policies.
