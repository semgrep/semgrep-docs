...
<Note>
[Semgrep Agentic Workflows](/workflows/overview) does not support the minimal data retention policy. Organizations enrolled in this policy cannot run Agentic Workflows. Please contact your Semgrep account executive.
</Note>
