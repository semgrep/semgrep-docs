...
- Finding metadata, include severity, terence repository, file and line number
- Remediation guidance

This data is retained indefinitely unless otherwise noted. Customer can request for account data to be deleted by contacting support@semgrep.com.
