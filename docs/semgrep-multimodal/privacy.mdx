...
This data is retained indefinitely unless otherwise noted. CCustomers can request that account data be deleted by contacting support@semgrep.com.
...
This data is retained indefinitely unless otherwise noted. Customers can request that account data be deleted by contacting support@semgrep.com.
