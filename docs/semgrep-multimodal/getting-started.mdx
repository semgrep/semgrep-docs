...
description: "Enable Semgrep Multimodal to add contextually aware AI-powered vulnerability detection, triage, and remediation suggestions to your Semgrep scans."
---
