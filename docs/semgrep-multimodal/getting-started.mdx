...
* You have set rules to **Comment** or **Block** mode in your <a href="https://semgrep.dev/orgs/-/policies" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> Policies page</a>.
</Note>
...
<Steps>
  <Step>
Sign in to <a href="https://semgrep.dev/login" target="_blank" rel="noopener noreferrer">Semgrep AppSec Platform <Icon icon="external-link" iconType="solid"/></a> using your GitLab account.
  </Step>
  <Step>
Go to **Settings > Global**, and click the **Semgrep Multimodal** toggle to enable.
  </Step>
