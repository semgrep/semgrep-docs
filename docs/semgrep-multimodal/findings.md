...
The **Status** filter allows you to search for findings in the selected statuses. See [Triage status](/semgrep-multimodal/triage-remediation#triage-statuses) for additional information.
...
2. Findings generated by [Pro rules](/semgrep-multimodal/pro-rules)
...
- Learn more about [viewing a finding's details](/semgrep-multimodal/finding-details).
- Learn how to [triage and remediate Semgrep Code findings](/semgrep-multimodal/triage-remediation).
- Learn how to [get cross-file (interfile) findings for your organization](/semgrep-multimodal/semgrep-pro-engine-intro)
