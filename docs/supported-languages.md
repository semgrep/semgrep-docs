...
_†Refers to functionality in Semgrep Cloud Platform to display through a badge which dependencies are transitive or direct. This does not affect reachability analysis for any language._<br />
