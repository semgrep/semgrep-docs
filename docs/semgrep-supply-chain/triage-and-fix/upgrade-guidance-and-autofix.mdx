...
| Semgrep features available | [Read and write access on the `contents` scope granted](/semgrep-appsec-platform/scm-code-access#grant-code-access-to-semgrep-with-a-private-github-app) | [Code access granted to Semgrep through installation of the private GitHub app](/deployment/managed-scanning/github#permissions) | [Semgrep Multimodal enabled](/semgrep-multimodal/getting-started) | [Private registry connected to Semgrep](/kb/semgrep-supply-chain/connect-a-private-registry) |
| :--- | :--- | :--- | :--- | :--- |
