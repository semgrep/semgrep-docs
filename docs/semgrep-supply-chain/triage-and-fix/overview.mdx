...
- Remove the dependency and refactoring the codebase to remove all usage.
...
With the information from Upgrade Guidance, **Autofix** can open pull requests and merge requests that updates the version used by your project and guide you through any breaking changes the update introduces.
