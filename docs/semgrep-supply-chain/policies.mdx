...
description: "Create and manage Semgrep Supply Chain policies that define scope, conditions, and actions—like commenting on or blocking PRs and MRs for findings."
---
