...
Legacy policies for Semgrep Supply Chain have been deprecated. However, if you haven't migrated to [Unified Policies](/semgrep-appsec-platform/unified-policies/overview), refer to the information in the following expandable section to view and manage your existing policies.

<Accordion
    title="Legacy policies for Semgrep Supply Chain (deprecated)"
>
...
<Step>
From the navigation bar, click **Rules & Policies**.
</Step>
<Step>
