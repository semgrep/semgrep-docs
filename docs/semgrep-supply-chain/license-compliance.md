...
![Screenshot of Semgrep Supply Chain Dependencies tab with licenses listed](/img/sc-license-configuration.png#md-width)
...
![Screenshot of license configuration section](/img/sc-license-configuration.png#md-width)
