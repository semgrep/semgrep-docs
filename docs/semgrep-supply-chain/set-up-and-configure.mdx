---
title: "Set up and configure Supply Chain"
description: "Learn about the setup needed to scan your project with Semgrep Supply Chain and its configuration and customization options."
---
...
### Rule updates
Supply Chain [frequently receives rule updates](/overview#new-cves-and-rule-updates). To take advantage of these updates, adjust the frequency with which Supply Chain scans your codebase.
...
- [Additional finding details](/semgrep-supply-chain/findings), such as whether the finding is always reachable or if it's reachable if certain conditions are met, and its transitivity status
...
- [License compliance](/semgrep-supply-chain/license-compliance) to manage the dependencies used in your project based on its license
