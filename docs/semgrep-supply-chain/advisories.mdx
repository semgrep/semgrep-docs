...
description: "View vulnerability advisories on the Advisories page in Semgrep Supply Chain and search across your projects for findings related to a given advisory."
---
