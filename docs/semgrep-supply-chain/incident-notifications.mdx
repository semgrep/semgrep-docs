...
Projects that don't meet these conditions are still checked against your most recent dependency data for the notification itself. To scan them, see [Initiate scans on potentially affected projects](/semgrep-supply-chain/incident-response#3-initiate-scans-on-potentially-affected-projects-with-semgrep-rules).
</Note>
