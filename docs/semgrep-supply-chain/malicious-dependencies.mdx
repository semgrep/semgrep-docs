...
description: "Detect malicious dependencies (malware) with Semgrep Supply Chain, including supported package managers, how to enable the feature, and reviewing findings."
---
