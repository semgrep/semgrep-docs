...
If you have configured your policies to display malicious dependency findings to your developers, and you have enabled **Settings > General > Global > Default developer triage permissions**, your developers are able to triage these findings as **Ignored**.
</Warning>
