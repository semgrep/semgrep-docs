...
| [CVE](https://www.cve.org/) | You can manually provide a CVE ID or a rule name, or you can choose from a list of values. The values listed are generated from findings identified by Semgrep Supply Chain.  |
