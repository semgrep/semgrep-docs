...
description: "Configure license compliance in Semgrep Supply Chain with Allow, Comment, and Block policies for dependency licenses and per-package overrides."
---
