...
* **Ignored**: Vulnerabilities that have been triaged as **Ignored** by the user. You can further filter findings with a status of **Ignored** by reason:  **False positive**, **Acceptable risk**, **No time to fix**.
