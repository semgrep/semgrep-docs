...
| **EPSS probability**   | Exploit prediction scoring system (EPSS) probability. Represents the likelihood that the vulnerability will be exploited in the wild in the next 30 days. Values range from 0% to 100% where the higher the score, the greater the probability the vulnerability is exploited. Semgrep groups probabilities as follows: <ul><li><b>High</b>: 50 - 100%</li><li><b>Medium</b>: 10 - &#60;50%</li><li><b>Low</b>: &#60;10% </li></ul> |
