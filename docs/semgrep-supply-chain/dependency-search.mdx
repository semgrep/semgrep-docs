...
description: "Enable dependency search in Semgrep Supply Chain to view and query direct and transitive dependencies across all projects in your organization."
---
