...
Semgrep currently supports integrations with private Maven package registries for [scans without lockfiles](/semgrep-supply-chain/set-up-and-configure#scan-a-project-without-lockfiles-beta).
