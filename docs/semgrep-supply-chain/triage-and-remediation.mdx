...
description: "Assess, triage, and remediate Semgrep Supply Chain findings, including handling true positives, provisionally ignored findings, Upgrade guidance, and Autofix."
---
