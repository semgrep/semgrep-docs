...
| References | Links to the specific CVE. References can come from NIST, Electron release notes, and GitHub Security %%Advisory\|advisory%%. |
| %%Source\|source%% | The primary source of this vulnerability's advisory. |
