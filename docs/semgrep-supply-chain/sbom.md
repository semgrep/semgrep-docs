...
- You need at least one successful Supply Chain scan on the **trunk** branch of each repository you want to generate an SBOM for. See [<i class="fa-regular fa-file-lines"></i> Core deployment](/deployment/core-deployment) to set up your Semgrep AppSec Platform account and Supply Chain scans.
:::
...
3. Once Semgrep AppSec Platform has generated the SBOM, click the link provided on the toaster notification to download it.
