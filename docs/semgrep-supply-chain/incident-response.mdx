...
![Sample dependency search for lodash 4.17 or later.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-1.png)
</Frame>
...
![Select and run Managed Scans projects manually.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-2.png)
</Frame>
...
![View affected projects for a specific advisory.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-3.png)
</Frame>
...
![Search for advisories by package name.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-4.png)
</Frame>
...
![Advisory details dialog with no findings found.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-5.png)
</Frame>

Before concluding you're not affected, verify that the rules corresponding to the incident were included in recent scans.

If there are results, Semgrep shows the number of findings by project, as well as the breakdown of which branches in the codebase are impacted:

<Frame caption="Figure. Advisory details dialog with findings found.">
![Advisory details dialog with findings found.](/images/kb/semgrep-supply-chain/incident-response/ssc-incident-6.png)
</Frame>
