...
description: "View Semgrep Supply Chain findings in AppSec Platform, including the Priority tab, the All tab, and how to define custom priority for findings."
---
