...
description: "View details for a specific Semgrep Supply Chain finding, including advisory information, reachability, dependency paths, and remediation options."
---

The **finding's details** page displays in-depth information about the finding, including:

- A detailed description of the <Tooltip tip="Result of Semgrep's analysis generated when a rule matches code. Findings can represent security issues, bugs, or violations of conventions." cta="See full definition." href="/writing-rules/glossary#finding">Finding</Tooltip>
...
- <Tooltip tip="Publicly available code used as part of your application. Dependencies are listed in registries such as npm for JavaScript and PyPI for Python." cta="See full definition." href="/semgrep-supply-chain/glossary#dependency">Dependency</Tooltip> path information
