...
description: "Reference table of GA and beta languages supported by Semgrep Code and Semgrep Supply Chain, with analysis capabilities and rule counts per language."
---
