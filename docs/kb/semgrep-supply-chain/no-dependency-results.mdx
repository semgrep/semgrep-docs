---
title: "Troubleshoot missing results on the Dependencies page"
description: "Troubleshoot why no dependencies appear on the Semgrep Supply Chain Dependencies page, including lockfile support and dependency search prerequisites."
---
