...
<Info>
If you've configured [Supply Chain incident notifications](/semgrep-supply-chain/incident-notifications), Semgrep will notify you on Slack within minutes of declaring an incident and tell you whether any of your projects are affected. In this case, you can skip this step, which describes the manual process and is useful if you haven't configured notifications or want to investigate a package independently of an automatic notification.
</Info>
