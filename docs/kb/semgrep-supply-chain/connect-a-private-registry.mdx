...
- [Open Autofix pull requests or merge requests](/semgrep-supply-chain/autofix).
- [Generate Upgrade Guidance for Supply Chain findings](/semgrep-supply-chain/upgrade-guidance).
