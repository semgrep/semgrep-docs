...
To connect a private registry to Semgrep, allowing Semgrep to open Autofix pull requests or merge requests, and to generate upgrade guidance for Supply Chain findings:
