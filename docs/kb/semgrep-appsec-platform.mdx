...
<CardGroup cols={2}>
  ...
  <Card title="SCIM provisioning with Okta" href="/kb/semgrep-appsec-platform/scim-okta" icon="file">
    Set up SCIM user and group provisioning for Semgrep AppSec Platform with Okta.
  </Card>
  <Card title="SCIM provisioning with Microsoft Entra ID" href="/kb/semgrep-appsec-platform/scim-microsoft-entra-id" icon="file">
    Set up SCIM user and group provisioning for Semgrep AppSec Platform with Microsoft Entra ID.
  </Card>
  ...
  <Card title="Why am I seeing a 'No SCMs with code access found' error when enabling code snippets in AI prompts?" href="/kb/semgrep-appsec-platform/gitlab-no-scms-with-code-access-found
" icon="file">
    Learn how to correct GitLab connection issues when enabling Semgrep Multimodal.
  </Card>
  <Card title="Findings in open status instead of provisionally ignored when flagged as false positives" href="/kb/semgrep-appsec-platform/findings-in-open-not-provisionally-ignored" icon="file">
