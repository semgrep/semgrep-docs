...
description: "Run a specific Semgrep CLI version—stable, latest, or a pinned release—to test upgrades, reproduce issues, or compare scan behavior across versions."
---
