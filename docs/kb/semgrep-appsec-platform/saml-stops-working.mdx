...
If the certificate isn't expired or outside its validity dates, verify that it matches the certificate used by the IdP, and that the certificate has not been revoked.
