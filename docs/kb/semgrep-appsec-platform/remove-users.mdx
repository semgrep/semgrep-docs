...
<Steps>
    <Step>
    Sign in to [<Icon icon="arrow-up-right-from-square" /> Semgrep AppSec Platform](https://semgrep.dev/login), and navigate to **Settings > Access > Login Methods**.
    </Step>
    <Step>
    Click the <Icon icon="toggle-large-on" iconType="solid" /> toggle for **GitHub SSO** or **GitLab SSO** to turn off the sign-in method.
    </Step>
</Steps>
