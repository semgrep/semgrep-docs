...
<Steps>
  ...
  In DefectDojo:
      ...
      i. Create your [**product**](https://defectdojo.github.io/django-DefectDojo/usage/models/#products). <br />
...
- `engagement_name`: The name of the engagement you created in the preceding "Integration" section. In this example, `semgrep`.
...
<Frame>
![image info](/images/kb/integrations/defect-dojo-integration/integration-defectdojo-gitlab-variables.png)
</Frame>
...
<Frame>
![image info](/images/kb/integrations/defect-dojo-integration/integration-defectdojo-example.png)
</Frame>
