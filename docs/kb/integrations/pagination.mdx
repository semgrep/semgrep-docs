...
<Card title="List code or supply chain findings" horizontal icon="code" href="/api-reference/findingsservice/list-code-supply-chain-or-ai-powered-scan-findings" />
</CardGroup>
