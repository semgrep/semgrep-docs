...
<Card title="List code or supply chain findings" horizontal icon="code" href="/api-reference/v1/findingsservice/list-code-supply-chain-or-ai-powered-detection-findings" />
</CardGroup>
