...
import CloudArrowUp from '/src/components/svgs-for-docs/svg/cloud-arrow-up.svg'
import CicleCheck from '/src/components/svgs-for-docs/svg/circle-check-solid.svg'
import CodePullRequest from '/src/components/svgs-for-docs/svg/code-pull-request-solid.svg'
import EarthAmericas from '/src/components/svgs-for-docs/svg/earth-americas-solid.svg'
import FloppyDisk from '/src/components/svgs-for-docs/svg/floppy-disk-solid.svg'
import CodeBranch from '/src/components/svgs-for-docs/svg/code-branch-solid.svg'
