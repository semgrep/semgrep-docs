...
To stay fast and limit complexity, we draw a line at crossing file boundaries during analysis. We lose the ability to detect certain complex cross-function issues, but that’s an explicit tradeoff we make.<br/><br/>
