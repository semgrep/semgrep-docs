...
Scan results can be triaged and remediated in the Semgrep AppSec Platform. The platform includes Semgrep Multimodal, which includes suggestions on how to fix Semgrep Code and Secrets findings.
...
<Frame caption="Overview of Semgrep AppSec Platform.">
  ![Overview of Semgrep AppSec Platform](/images/appsecplatform-intro-af4e86f3bc2a3e22dc5ac7bf89056813.png)
</Frame>
...
Remediation is the process of fixing security issues identified during scanning. Semgrep supports remediation by providing detailed findings, contextual code examples, [Suggested fix](/semgrep-multimodal/overview#suggested-fix) suggestions on how to fix findings from Semgrep Multimodal, [Rule-defined fix](/writing-rules/rule-defined-fix) suggestions in pull request or merge request comments, and [Autofix](/semgrep-code/triage-remediation/autofix) for AI-generated code changes. These tools help developers quickly implement secure fixes while maintaining development speed.
