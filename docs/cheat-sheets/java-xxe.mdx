...
See creative process of a Semgrep rule that detects XXE vulnerabilities. You can create and improve your own rules using [Semgrep Playground](https://semgrep.dev/playground) as you may see in the following video:
