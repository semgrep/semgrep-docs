...
See an example of such a payload, called also an XML bomb, in [Semgrep's research project on GitHub](https://github.com/returntocorp/java-xxe-research/blob/main/payloads-new/xml-attacks/xml-bomb.xml).
