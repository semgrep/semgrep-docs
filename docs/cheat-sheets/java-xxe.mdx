...
There are several security measures, but not all of them are available for each class. To see an overview of which measures are available for which class, consult the docs, or go to Section 3 to view the tables with our research results.
