...
There are several security measures, but not all of them are available for each class. See an overview of which measures are available for which class in section [2.C Overview of the effect of security measures for each class](#2c-overview-of-the-effect-of-security-measures-for-each-class) with r2c research results.
...
### 2.C Overview of the effect of security measures for each class
