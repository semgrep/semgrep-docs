...
```bash
semgrep scan --config p/minusworld.ruby-on-rails-xss
```

[PDF of this cheat sheet](https://web-assets.r2c.dev/security-cheat-sheets/xss/r2c-security-cheat-sheet-xss-prevention-for-ruby-on-rails.pdf)
