...
<LinkToRegistryRule ruleId="java.lang.security.audit.tainted-cmd-from-http-request.tainted-cmd-from-http-request" />
...
<LinkToRegistryRule ruleId="java.servlets.security.tainted-cmd-from-http-request.tainted-cmd-from-http-request" />
