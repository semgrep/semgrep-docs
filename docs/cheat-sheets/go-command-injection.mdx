...
sidebarTitle: "Command Injection in Go"
---
...
[`go.lang.security.audit.dangerous-exec-command.dangerous-exec-command`](https://semgrep.dev/r/go.lang.security.audit.dangerous-exec-command.dangerous-exec-command)
...
func main() {
  ...
  // Args can be also omitted and {Path} will be used by default
  cmd := &exec.Cmd {
    Path: "/bin/echo"
  }
...
[`go.lang.security.audit.dangerous-exec-cmd.dangerous-exec-cmd`](https://semgrep.dev/r/go.lang.security.audit.dangerous-exec-cmd.dangerous-exec-cmd)
...
[`go.lang.security.audit.dangerous-command-write.dangerous-command-write`](https://semgrep.dev/r/go.lang.security.audit.dangerous-command-write.dangerous-command-write)
...
[`go.lang.security.audit.dangerous-syscall-exec.dangerous-syscall-exec`](https://semgrep.dev/r/go.lang.security.audit.dangerous-syscall-exec.dangerous-syscall-exec)
