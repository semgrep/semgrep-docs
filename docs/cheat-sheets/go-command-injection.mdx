...
- Avoid running shell as a command with arguments, if it is not possible, then strip everything except alphanumeric characters from an input provided for the command string and arguments.
