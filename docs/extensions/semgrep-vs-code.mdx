...
Tip: You can click the Semgrep icon in Visual Studio Code to access all available commands quickly.
</Tip>
...
<Steps>
  ...
  <Step>
    Explore the Semgrep Registry, select a rule, and then click **Add to detection policy**. You can view and manage your rules in [Policies](https://semgrep.dev/orgs/-/detection).
  </Step>
  <Step>
