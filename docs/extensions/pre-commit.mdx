...
description: "Set up the pre-commit framework to run Semgrep scans on staged changes, blocking secrets and security issues before they reach your Git history."
---
