...
description: "Run Semgrep as a pre-commit hook to catch security issues before code is committed, using Semgrep CE or a Semgrep AppSec Platform configuration."
---
