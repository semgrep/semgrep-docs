...
- Have [auto-fix](https://semgrep.dev/docs/writing-rules/rule-defined-fix) capabilities that can automatically fix the vulnerability in the susceptible piece of code.
