...
<iframe src="https://semgrep.dev/embed/playground?snippet=P8oz" border="0" frameBorder="0" width="100%" height="435"></iframe>
...
You can find more examples of taint rules in the [Semrep Registry](https://semgrep.dev/r?owasp=injection%2Cxss), for instance: [express-sandbox-code-injection](https://semgrep.dev/playground?registry=javascript.express.security.express-sandbox-injection.express-sandbox-code-injection).
...
<iframe src="https://semgrep.dev/embed/playground?snippet=XO6q" border="0" frameBorder="0" width="100%" height="435"></iframe>
...
<iframe src="https://semgrep.dev/embed/playground?snippet=jwey" border="0" frameBorder="0" width="100%" height="435"></iframe>
...
<iframe src="https://semgrep.dev/embed/playground?snippet=y1jZ" border="0" frameBorder="0" width="100%" height="435"></iframe>
...
<iframe src="https://semgrep.dev/embed/playground?snippet=9rJ2" border="0" frameBorder="0" width="100%" height="435"></iframe>
...
<iframe src="https://semgrep.dev/embed/playground?snippet=Q64P" border="0" frameBorder="0" width="100%" height="435"></iframe>

For it to work, you must use different metavariables:

<iframe src="https://semgrep.dev/embed/playground?snippet=Pg8q" border="0" frameBorder="0" width="100%" height="435"></iframe>
