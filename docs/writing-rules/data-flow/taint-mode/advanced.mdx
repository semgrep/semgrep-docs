...
sidebarTitle: "Advanced techniques for taint analysis"
---
...
<Accordion title="Original implementation for tainting variables by side effect">
...
<Accordion title="Original implementation for tainting sanitizers by side effect">
...
You can use this behavior, for example, to check that file descriptors are being closed within the same function where they were opened.
