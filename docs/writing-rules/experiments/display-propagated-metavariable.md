...
<iframe title="Metavariable value in message example" src="https://semgrep.dev/embed/editor?snippet=Dr0G" width="100%" height="432" loading="lazy" frameborder="0"></iframe>
