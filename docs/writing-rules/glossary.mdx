...
An example of a sanitizer is the <a href="https://github.com/cure53/DOMPurify" target="_blank" rel="noopener noreferrer"><Icon icon="external-link" iconType="solid"/> `DOMPurify.sanitize(dirty);`</a> function from the  DOMPurify package in JavaScript.
