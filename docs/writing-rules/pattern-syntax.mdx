...
1. Find the metavariable used in Semgrep rule. For example:
    ```yaml
...
<iframe title="Metavariable value in message example" src="https://semgrep.dev/embed/editor?snippet=returntocorp:returntocorp:metavariable-message-example" width="100%" height="432" frameborder="0"></iframe>
