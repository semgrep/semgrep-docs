...
To display matched metavariable in rule message:
...
:::info
There are specific limitations for nested variables which Semgrep cannot process correctly under specific circumstances. For more information see documentation of experimental feature [Displaying propagated value of metavariable](/experiments/display-propagated-metavariable-message)
:::
