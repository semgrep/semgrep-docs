...
:::info
If you're using Semgrep's advanced dataflow features, see documentation of experimental feature [Displaying propagated value of metavariable](/experiments/display-propagated-metavariable-message).
:::
