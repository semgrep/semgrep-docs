...
| `decorators_order_matters` | `false` | Match non-keyword attributes (e.g. decorators in Python) in order, instead of the order-agnostic default. Keyword attributes (e.g. static, inline, etc) are not affected. |
