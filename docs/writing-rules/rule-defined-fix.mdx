...
description: "Rule-defined fix is a Semgrep feature that lets rule authors add suggested code changes to rules so scans can propose or apply automatic fixes."
---
