...
Semgrep's [dataflow engine with support for taint tracking](/writing-rules/data-flow/) can be used to detect when data flows from a user-provided value into a security-sensitive function.
