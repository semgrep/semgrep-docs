...
description: "Definitions of Semgrep's language maturity levels—GA, beta, experimental, and community supported—used on the Supported languages reference page."
---
