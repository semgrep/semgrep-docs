...
by [editing the Semgrep App policy](../managing-policy/#editing-a-policy)
used for your scans.
...
You can set this up
by [changing the actions of the Semgrep App policy](../managing-policy/#changing-policy-actions)
used for your scans.
