...
- Historical findings: Findings that were created before automatic analysis was enabled for your deployment. Automatic analysis for full scans was enabled on November 10, 2025.
- Additional PR or MR findings: The 11th finding or later on the same PR or MR (only the first 10 are automatically analyzed)
