...
You can view findings that Assistant suggests should be **Ignored** in Semgrep AppSec Platform's **Findings page**. <!-- #10438 -->
...
You can view findings for which Assistant has generated autofix snippets in Semgrep AppSec Platform's **Findings page**. <!-- #10438 --> 
