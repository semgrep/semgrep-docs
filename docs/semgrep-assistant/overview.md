...
Semgrep Assistant primarily supports findings generated by Semgrep Code. It requires Semgrep Cloud Platform (SCP).
...
![Semgrep Assistant generating a potential fix in a commment](/img/semgrep-assistant-autofix.png)
