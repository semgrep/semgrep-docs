...
* Semgrep stores and retains AI responses based on these code snippets for up to 6 months. Semgrep, Inc. will update you with at least 30-days' notice if we make any changes to the retention policy.<!-- markdown-link-check-disable -->
