...
* When using Semgrep Assistant, source code **does** leave your repository; Assistant submits part of the file with a finding to OpenAI for processing by an AI model. OpenAI is not allowed to use the submitted code to train its models.
