...
- Updated [Managing findings in Semgrep App](/semgrep-multimodal/findings) document, especially [Managing finding status](/semgrep-multimodal/triage-remediation/#manage-findings) section to inform about the latest triage workflow updates.
