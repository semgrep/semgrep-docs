...
- Added a [list of default branch names](/semgrep-multimodal/glossary#default-branch) that Semgrep uses to identify trunk or mainline branches.
...
- Major updates have been made to the following documentation:
  ...
  - [Pro rules](/semgrep-multimodal/pro-rules)
