...
- Added a new section [Updating Semgrep Pro Engine in CLI](/semgrep-multimodal/semgrep-pro-engine-intro#update-cross-file-analysis-in-the-cli).
...
- Added [Semgrep Pro Engine CI scans](/semgrep-multimodal/semgrep-pro-engine-intro#run-cross-file-analysis-in-the-cli) section.
- Added new [Policies](/semgrep-multimodal/policies) page documentation, also updated **Rule board** documentation with an admonition about Policies page.
...
- Admonitions regarding the new Turbo mode were added to Playground and Editor documentation. Go to [Playground](/semgrep-multimodal/editor) documentation and search for turbo mode.
