...
- The **Rule board** has been deprecated and removed. The [Policies page](/semgrep-multimodal/policies) is now the default and sole page for rule management in Semgrep Cloud Platform.
...
- Added the following knowledge base articles:
    - [Semgrep scan troubleshooting](/kb/semgrep-multimodal/semgrep-scan-troubleshooting)
    - [Resolving SSO error BadRequest: Missing attribute](/kb/semgrep-appsec-platform/sso-attribute-error)
    - [How to run different versions of Semgrep](/kb/semgrep-multimodal/run-specific-version)
