...
* The Policies page is now the default page used to manage rules. See the [Policies](/semgrep-multimodal/policies) documentation for more information.
...
* The **Rule board** has been deprecated and removed. To manage findings, use the **Policies page**. See the [Policies documentation](/semgrep-multimodal/policies) for more information.
