...
- Knowledge base articles:
    ...
    - [Troubleshooting "You are seeing this because the engine was killed" on monorepos](/kb/semgrep-multimodal/scan-engine-kill) <!-- 1310 -->
...
- Updated the [Findings](/docs/semgrep-multimodal/findings) documentation page.
